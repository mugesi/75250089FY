...
In this  tutorial, we will do exercises regarding the criterion and content validity. In doing so we will also tackle some data wrangling tasks. Below is a detailed information on the datasets we will use.
