...
In this tutorial, we will carry out exercises on criterion-related validity and construct validity. We will also deal with some data wrangling tasks. Below you will find detailed information on the data sets we will use.
